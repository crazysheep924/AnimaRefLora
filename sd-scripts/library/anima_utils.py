...
def load_anima_model(
    ...
    # Official Anima checkpoints prefix DiT weights with "net."; ComfyUI-packaged
    # community finetunes use "model.diffusion_model." — accept both.
    def _strip_dit_prefix(k: str) -> str:
        for prefix in ("net.", "model.diffusion_model."):
            if k.startswith(prefix):
                return k[len(prefix) :]
        return k

    rename_hooks = WeightTransformHooks(rename_hook=_strip_dit_prefix)
